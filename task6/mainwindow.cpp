    ...
    , ui(new Ui::MainWindow)
{
    ...
    graphClass = new Graphic(dialog->get_ptr(),1);
    connect(this,&MainWindow::finish_write_data,this,&MainWindow::write_data_finished);
}
...
void MainWindow::write_data_finished()
{
    graphClass->ClearGraph(dialog->get_ptr());
    graphClass->AddDataToGrahp(x,y,0);
    graphClass->UpdateGraph(dialog->get_ptr());
    dialog->show();
}
